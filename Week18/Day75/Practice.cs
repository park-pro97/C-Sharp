...
Mat bgrPalette = new Mat();
            ...
            return bgrPalette;
----------------------------------------------------------------
//차트 그리고 위의 코드로 색을 넣어봄
using OpenCvSharp;

namespace HistogramDraw02
{
    internal class Program
    {
